...
//     another_another_another_another_main();
...
// //     println!("{s1}, world!"); // -> will through error as Rust moves value of s1 to s2 making s1 invalid

// //     // to clone it we can use: 
// //     let s2 = s1.clone();
// // }
...
// fn another_another_another_another_main() {
...
fn main() {
    let mut s = String::from("Hellos World");
